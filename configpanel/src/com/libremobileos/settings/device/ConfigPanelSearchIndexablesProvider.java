...
package com.libremobileos.settings.device;
...
import com.libremobileos.support.util.PackageManagerUtils;
...
public class ConfigPanelSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    private static Object[] generateResourceRef(SearchIndexableResource sir) {
        ...
        ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = "com.libremobileos.settings.device";
    ...
    private List<String> getNonIndexableKeys(Context context) {
        ...
        if (!PackageManagerUtils.isAppEnabled(context, "com.libremobileos.pocketmode")) {
