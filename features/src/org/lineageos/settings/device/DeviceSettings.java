...
import org.aospextended.settings.device.kcal.KCalSettingsActivity;
import org.aospextended.settings.device.preferences.SecureSettingCustomSeekBarPreference;
import org.aospextended.settings.device.preferences.SecureSettingListPreference;
import org.aospextended.settings.device.preferences.SecureSettingSwitchPreference;
import org.aospextended.settings.device.preferences.VibrationSeekBarPreference;
...
public class DeviceSettings extends PreferenceFragment implements
    ...
    private static final String DEVICE_DOZE_PACKAGE_NAME = "org.aospextended.settings.doze";
