...
public class ButtonUtils {
    ...
    public static boolean hasButtonProcs() {
        return (FileUtils.fileExists(ButtonConstants.CYTTSP_BUTTON_SWAP_NODE) ||
                FileUtils.fileExists(ButtonConstants.FP_HOME_KEY_NODE) ||
                FileUtils.fileExists(ButtonConstants.FP_WAKEUP_NODE) ||
                FileUtils.fileExists(ButtonConstants.TOUCHPANEL_BUTTON_SWAP_NODE));
    }
